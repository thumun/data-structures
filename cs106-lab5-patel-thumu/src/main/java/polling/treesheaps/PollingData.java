...
public class PollingData implements Comparable<PollingData> {
	...
	/**
	 * compares the last name of one object with the last name of the other and
	 * return a value dictating which one is alphabetically before the other
	 * 
	 * @param PollingData o (object of PollingData class)
	 * @return integer value of -1, 1, or 0 depending on if this.last name is
	 *         alphabetically before or not or the same
	 */
	@Override
