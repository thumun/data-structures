...
public class Person {
    ...
    /** 
	 * enum to categorize sex parameter
	 * takes Male and Female into account
	 * @param N/A
	 * @return N/A
	 */
	public enum Sex{
    ...
    /** 
	 * enum to categorize race parameter
	 * takes Asian, African American, Caucasian, Hispanic, Native American, and Other
	 * @param N/A
	 * @return N/A
	 */
	public enum Race{
		ASIAN, AFRICAN_AMERICAN, CAUCASIAN, HISPANIC, NATIVE_AMERICAN, OTHER 
	};
	
    /** 
	 * enum to categorize current charge degree
	 * takes Felony and Misdemeanor
	 * @param N/A
	 * @return N/A
	 */
    ...
    /** 
	 * enum to categorize recid charge degree
	 * takes F1, F2, F3, F5, F6, F7, M1, M2, M3, MO3, CO3, and NO_R_CHARGE 
	 * @param N/A
	 * @return N/A
	 */
	public enum RChargeDegree{
		F1, F2, F3, F5, F6, F7, M1, M2, M3, MO3, CO3, NO_R_CHARGE
	};
	 ...
	 * @param input (Matches string input with appropriate constant in enum. 
	 * 		If input not recognized, throws error)
	 * @return N/A
	...
	public void setRace(String input) throws Exception {
		...
		else if (input.equals("Native American")) {
	...
	public void setrChargeDegree (String input) throws Exception {
		if (input.equals("(F1)")) {
			...
			rChargeDegree = RChargeDegree.F5;
		}
		else if (input.equals("(F6)")){
			rChargeDegree = RChargeDegree.F6;
		}
		else if (input.equals("(F7)")){
			rChargeDegree = RChargeDegree.F7;
		}
		...
		else if (input.equals("(MO3)")){
			rChargeDegree = RChargeDegree.MO3;
		}
		else if (input.equals("(CO3)")){
			rChargeDegree = RChargeDegree.CO3;
		}
		else if(input.equals("")) {
			rChargeDegree = RChargeDegree.NO_R_CHARGE;
		}
		else {
			// if input is not "F1" or "F2" or "F3" or "M1" or "M2" or "M3" or "" 
			// then invalid & throws exception
    ...
    /** 
	 * outputs the different parameters in string form
	 * @param N/A
	 * @return string containing race and scoreText instance variables 
	 */
    @Override
	public String toString() {
		return sex+" "+race+" "+cChargeDegree+" "+decileScore+" "+scoreText+" "
				+" "+twoYearRecid+" "+rChargeDesc+" "+rChargeDegree;
	}
}
